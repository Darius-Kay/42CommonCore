...
/*   Updated: 2025/11/23 15:21:46 by dakaymak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int is_in_kleinian(t_mlx mlx, double c_r, double c_i)
{
    double z_r;
    double z_i;
    double mag_sq;
...
void kleinian(t_mlx *pmlx, t_mlx mlx, double x, double y)
{
    ...
    while (x < mlx.info.width)
    {
        ...
        {
            frac_calc = is_in_kleinian(mlx,
                (x / (mlx.coord.zoom) + mlx.coord.offx),
